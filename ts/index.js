...
function armfunction() {
    ...
    reader.onload = () => {
        imageProducto.src =(reader.result);
    };
...
function saveTable() {
    ...
    let jsonTable=[]
    for (let r=3; r<tableta.rows.length; ++r)
    {
        let id = tableta.rows[r].cells[0].innerHTML
          , nombre = tableta.rows[r].cells[1].innerHTML
          , imagen      = tableta.rows[r].cells[6].firstElementChild.src
        jsonTable.push( {id,nombre,imagen} )
        }
console.log(jsonTable)

    localStorage.setItem("tableProd", tableta.innerHTML);
    localStorage.setItem("idprods", JSON.stringify(jsonTable))
...
function loadProductos() {
    var cable = (JSON.parse(localStorage.getItem("idprods")))
    var tableH1 = document.getElementById("headprod1")
    var tableH2 = document.getElementById("headprod2")
    var tableH3 = document.getElementById("headprod3")
    var tableH4 = document.getElementById("headprod4")
    var tableH5 = document.getElementById("headprod5")
    var tableH6 = document.getElementById("headprod6")

    var tableIMG1 = document.getElementById("imgprod1")
    var tableIMG2 = document.getElementById("imgprod2")
    var tableIMG3 = document.getElementById("imgprod3")
    var tableIMG4 = document.getElementById("imgprod4")
    var tableIMG5 = document.getElementById("imgprod5")
    var tableIMG6 = document.getElementById("imgprod6")


    if(cable[0] !==undefined)
    {
        tableH1.innerHTML = cable[0].nombre
        tableIMG1.src = cable[0].imagen
    }
    else
    {
       
        tableH1.style.opacity=0
        tableIMG1.style.opacity=0

    }
    if(cable[1] !==undefined)
    {
        tableH2.innerHTML = cable[1].nombre
        tableIMG2.src = cable[1].imagen
    }
        else
        {
          
            tableH2.style.opacity=0
            tableIMG2.style.opacity=0


        }
    if(cable[2] !==undefined)
    {
        tableH3.innerHTML = cable[2].nombre
        tableIMG3.src = cable[2].imagen
    }
    else
    {
   
        tableH3.style.opacity=0
        tableIMG3.style.opacity=0

    }
    if(cable[3] !==undefined)
    {
        tableH4.innerHTML = cable[0].nombre
        tableIMG4.src = cable[0].imagen
    }
    else
    {
       
        tableH4.style.opacity=0
        tableIMG4.style.opacity=0

    }
    if(cable[4] !==undefined)
    {
        tableH5.innerHTML = cable[1].nombre
        tableIMG5.src = cable[1].imagen
    }
        else
        {
          
            tableH5.style.opacity=0
            tableIMG5.style.opacity=0


        }
    if(cable[5] !==undefined)
    {
        tableH6.innerHTML = cable[2].nombre
        tableIMG6.src = cable[2].imagen
    }
    else
    {
   
        tableH6.style.opacity=0
        tableIMG6.style.opacity=0
